...
const buttonVariants = cva(
  'active:scale-95 text-lg font-medium inline-flex items-center justify-center rounded-md border-2 border-transparent focus:ring-2 ring-offset-2 ring-custom ring-offset-transparent transition outline-0 disabled:opacity-50 sm:h-8 sm:px-2 sm:text-sm',
  {
    variants: {
      btncolor: {
